...
import io.swagger.client.model.ConnectionStatusPredictionsSnapshotDTO;
...
public class ConnectionStatusSnapshotDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, groupId, name, sourceId, sourceName, destinationId, destinationName, predictions, flowFilesIn, bytesIn, input, flowFilesOut, bytesOut, output, flowFilesQueued, bytesQueued, queued, queuedSize, queuedCount, percentUseCount, percentUseBytes);
  }
