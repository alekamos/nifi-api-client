...
public class ControllerStatusDTO {
  ...
  **/
  @ApiModelProperty(value = "The number of terminated threads in the NiFi.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activeThreadCount, terminatedThreadCount, queued, flowFilesQueued, bytesQueued, runningCount, stoppedCount, invalidCount, disabledCount, activeRemotePortCount, inactiveRemotePortCount, upToDateCount, locallyModifiedCount, staleCount, locallyModifiedAndStaleCount, syncFailureCount);
  }
