...
import io.swagger.client.model.ConnectionStatusSnapshotEntity;
import io.swagger.client.model.PortStatusSnapshotEntity;
import io.swagger.client.model.ProcessGroupStatusSnapshotEntity;
import io.swagger.client.model.ProcessorStatusSnapshotEntity;
import io.swagger.client.model.RemoteProcessGroupStatusSnapshotEntity;
...
public class ProcessGroupStatusSnapshotDTO {
  ...
  **/
  @ApiModelProperty(value = "The status of all connections in the process group.")
  ...
  **/
  @ApiModelProperty(value = "The number of threads currently terminated for the process group.")
